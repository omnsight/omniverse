...
interface NetworkWindowManagerState {
...
export const useNetworkWindowManagerStore = create<NetworkWindowManagerState>((set, get) => ({
  windows: [],
  activeIndex: 0,
  actions: {
...
export const useNetworkWindowManagerActions = () =>
  useNetworkWindowManagerStore((state) => state.actions);
